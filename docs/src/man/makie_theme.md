...
**SatelliteAnalysis.jl** provides a [Makie](https://makie.org) theme with coordinated dark
...
function overview_figure(; dark::Bool)
    ...
    Label(
        fig[0, :],
        "SatelliteAnalysis.jl Makie theme — $(dark ? "dark" : "light") variant";
        fontsize = 26,
        font     = :bold,
        halign   = :left,
        padding  = (8, 0, 0, 0),
