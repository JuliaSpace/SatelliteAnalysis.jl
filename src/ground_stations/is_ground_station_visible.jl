...
# ==============================================================================
#
#   Functions to verify is a ground station is visibile given a satellite
#   position.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

export is_ground_station_visible

"""
    is_ground_station_visible(sat_r_e::AbstractVector, gs_r_e::AbstractVector, θ::Number)

Check if the satellite with position vector `sat_r_e` (ECEF) is inside the
visibility circle of a ground station with position vector `gs_r_e` (ECEF) and a
...
otherwise.
"""
function is_ground_station_visible(
...
"""
    is_ground_station_visible(sat_r_e::AbstractVector, gs_lat::Number, gs_lon::Number, gs_h::Number, θ::Number)

Check if the satellite with position vector `sat_r_e` (ECEF) is inside the
visibility circle of a ground station with latitude `gs_lat` [rad], longitude
...
function is_ground_station_visible(
    ...
    return is_ground_station_visible(sat_r_e, gs_r_e, θ)
end
