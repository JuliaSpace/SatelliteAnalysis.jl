...
@testset "Function makie_palette" begin
    @test makie_palette(6) == SAMakieExt.CATEGORICAL_LIGHT
    @test makie_palette(6; dark = true) == SAMakieExt.CATEGORICAL_DARK
    @test makie_palette(3) == SAMakieExt.CATEGORICAL_LIGHT[1:3]
