...
- ![Breaking][badge-breaking] The functions `eclipse_time_summary`,
  `ground_facility_accesses`, `ground_facility_gaps`,
...
- ![Breaking][badge-breaking] The automatic step selection in `eclipse_time_summary` is now
